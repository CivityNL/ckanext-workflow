...
def workflow_request_create_schema():
    ...
    return {
        ...
        'requester_id': [not_empty, unicode_safe, convert_user_name_or_id_to_id],
        'request_state': [not_empty, unicode_safe, workflow_request_state_exists],
        'request_message': [ignore_missing, unicode_safe],
        'request_timestamp': [empty_if_not_sysadmin, ignore_missing, isodate],

        'approver_id': [ignore_missing, unicode_safe, convert_user_name_or_id_to_id],
        'approve_message': [ignore_missing, unicode_safe],
        'approve_timestamp': [empty_if_not_sysadmin, ignore_missing, isodate],
        'approved': [ignore_missing, unicode_safe, boolean_validator],
...
def workflow_state_schema(roles, states):
    ...
    return {
        ...
        'update_events': workflow_state_update_event_schema(),
        'can_be_skipped': [boolean_validator]
    }


def workflow_state_update_event_schema():
    from_data_dict = workflow_is_function_with_parameters(["context", "data_dict"])
    return {
