...
validate_translate_dict = workflow_validators.validate_translate_dict
...
def workflow_state_schema(update_actions, permissions, states):
    return {
        ...
        'label': [not_empty, validate_translate_dict],
...
def workflow_transition_schema(permissions, states):
    return {
        ...
        'request_message_required': [default(False), boolean_validator],
        'approve_message_required': [default(False), boolean_validator],
        'reject_message_required': [default(False), boolean_validator],
        '__extras': [ignore],
    }
